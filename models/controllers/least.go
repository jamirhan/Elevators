...
func (controller *Least) NewCall(cur_states []core.StateBase, floors []core.Floor, floor core.Floor, panel int) (int, core.StateBase) {
	least_ind := 0
...
func (controller *Least) CabinFloorCall(state core.StateBase, floor core.Floor) core.StateBase {
	return states.PushBack(state.(states.SimpleQueue), floor)
}

func (controller *Least) IntentionToPanelState(core.Floor, core.Floor) int {
	return 0
}
